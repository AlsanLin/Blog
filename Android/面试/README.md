...
> 共 17 个模块，约 400+ 道面试题，覆盖 武汉 Android 高阶/专家岗 的全部考察范围。
...
| [**插件化架构**](/Android/面试/插件化架构面试题.md) | ClassLoader 原理、资源加载、四大组件代理、开源方案对比、插件间通信、实战深挖 |
...
| 模块 | 内容 |
|------|------|
| [**AI 移动端**](/Android/面试/AI移动端面试题.md) | 端侧模型部署、云端大模型接入、AI 功能落地工程化、AI 辅助开发、前沿方向 |
...
| 模块 | 内容 |
|------|------|
| [**简历项目深挖**](/Android/面试/简历项目深挖面试题.md) | 科大讯飞 / T11 / 光彩玳瑁 / 光明都市菜园 / 房多多 / 早期 / 个人项目 |
...
3. **设计模式 → 算法** 基础扎实才不怕追问
4. **插件化架构 → 简历项目深挖 → 项目及团队管理** 高阶岗必问，和你的真实经历绑定回答
5. **Flutter → 车机 Android** 差异化竞争力，按目标公司选择侧重
6. **AI 移动端 → TFLite** AI 时代加分项，你在讯飞有真实落地经验
7. **KMP** 有余力时再补
...
- 车机方向的面试知识在武汉市场权重大，建议优先熟悉 Car API 和 AAOS 基础
- 简历项目和插件化是你的核心优势，准备 3 个 STAR 故事，面试中自然带入
